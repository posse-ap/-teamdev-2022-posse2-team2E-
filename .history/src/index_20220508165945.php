    ...
    <wrapper>
        ...
        <div class="q_and_a">
            ...
            <container class="filter" id="js-filter">
                ...
                ?>
                    <!-- logoの保管場所作るagent_picture -->
                    <div class="<?php echo h($id); ?>">
                    <img src="agent_picture/<?php echo h($insert_logo)?>" width="48" height="48" alt="" />
                <?php echo $id ?>
                <?php  echo $started_at, $ended_at, $insert_company_name, $insert_logo, $insert_recommend_1  ?>
                ...
                <div class="filter_right_wrapper">
                    <btn class="keep_btn" id="keep_btn">
                        <div class="button05">
                            <a href="/src/user/keep.html"><button class="bn632-hover bn19" >キープ：<span id="keep_counter">０</span>件<br>確認する</button></a>
                        </div>
                    </btn>
                </div>
            </container>
