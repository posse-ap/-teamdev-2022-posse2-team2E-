...
function OnButtonClick() {
    ...
    // keep_counter = document.getElementById("keep_counter");
    let keep_agent_box = document.getElementsById("agent_box");
    keep.innerHTML = "キープ中";
    ...
    keep_agent_box.style.backgroundColor = "#C0C0C0";
  }
  ...
  function OnButtonClick() {
    ...
    // keep_agent_box.style.backgroundColor = "black";
  }
