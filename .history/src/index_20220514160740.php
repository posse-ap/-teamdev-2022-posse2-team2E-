                    ...
                    <li class="agent_box" data-filter-key="総合型">
                        ...
                        <div class="agent_article">
                            ...
                            <div class="agent_article_main">
                                ...
                                <p class="span_published">掲載期間：<?php echo $listed_agent['started_at'] ?>〜<?php echo $listed_agent['ended_at'] ?></p>
                            </div>
                            <div class="agent_article_footer">
                                <p class="agent_type"><?php echo $listed_agent['insert_recommend_1'] ?></p>
