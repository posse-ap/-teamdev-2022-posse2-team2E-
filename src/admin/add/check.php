...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $stmt = $db->prepare('insert into agents (corporate_name, started_at, ended_at, to_send_email, application_max, charge, client_name, client_department, client_email, client_tel, insert_company_name, insert_logo, insert_recommend_1, insert_recommend_2,insert_recommend_3, insert_handled_number, list_status) VALUES (:corporate_name,:started_at, :ended_at, :to_send_email, :application_max, :charge, :client_name, :client_department, :client_email, :client_tel, :insert_company_name, :insert_logo, :insert_recommend_1, :insert_recommend_2, :insert_recommend_3, :insert_handled_number, :list_status)');
