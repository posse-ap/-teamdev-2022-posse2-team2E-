    ...
    <div class="agent-add-table">
      <table class="main-info-table">
        ...
        <tr>
          ...
          <td><label class="list-status">
              <input type="radio" name="list-status" value="" /><span>掲載する</span>
            </label>
            <label class="list-status">
              <input type="radio" name="list-status" value="" /><span>掲載しない</span>
            </label>
          </td>
        </tr>
        ...
        <tr class="login-info">
          <th>ログイン情報</th>
          <td>
            email:<input type="email" name="ログイン用メールアドレス" />　　　pass:<input type="text" name="ログイン用パスワード" />
          </td>
        </tr>
      ...
      <table class="contact-info-talbe">
        ...
        <tr class="contact-number">
          ...
          <td>
            email:<input type="email" name="担当者メールアドレス" />　　　tel:<input type="tel" name="担当者電話番号" />
          </td>
        </tr>
      </table>
      <table class="post-info-talbe">
        ...
        <tr>
          ...
          <td>
            <input type="text" name="オススメポイント" /><input type="text" name="オススメポイント" /><input type="text" name="オススメポイント" />
          </td>
        </tr>
        <tr>
